...
import com.kelldavis.movieguide.model.CastResults;
...
import com.kelldavis.movieguide.network.MovieService;
...
public class NetworkUtils {
    ...
    /**
     * Load observable popular movies list.
     *
     * @param page the page
    ...
    /**
     * Load observable top rated movies list.
     *
     * @param page the page
     * @return the observable results
     */
    ...
    /**
     * Load observable review with id.
     *
     * @param id the id
     * @return the observable results
     */
    ...
    public static Observable<List<Cast>> loadCastWithId(String id){
        MovieService movieService = retrofit.create(MovieService.class);
        Observable<CastResults> castCall = movieService.getCastById(id, API_KEY);
        return castCall.subscribeOn(Schedulers.io())
                .map(scheduler-> scheduler.getCast());
    }

    /**
     * Get custom movie by query observable.
     *
